...
namespace SWS
{
    ...
    public class bezierMoveEditor : moveEditor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(m_Object.FindProperty("PointContainer")); ;
            ...
            EditorGUILayout.PropertyField(m_Object.FindProperty("indexs"));
            ...
            EditorGUILayout.PropertyField(m_Object.FindProperty("firstClip"));
            EditorGUILayout.PropertyField(m_Object.FindProperty("lastClip"));
            EditorGUILayout.PropertyField(m_Object.FindProperty("thuyenToBiaClip"));    
